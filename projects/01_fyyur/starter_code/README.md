...
3. Fill out every `TODO` section throughout the codebase. We suggest going in order of the following:
  ...
  Check out the sample pages provided at /artists/1, /venues/1, and /shows/1 for examples of the data we want to model, using all of the learned best practices in database schema design.
